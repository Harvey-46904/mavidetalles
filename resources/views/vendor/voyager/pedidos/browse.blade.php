...
<div class="page-content browse container-fluid">
    ...
    <span style="background:#42d17f; color:#000; padding:3px 8px; border-radius:5px; margin-left:8px;">
        Hoy
    </span>
    <span style="background:#6fc6da; color:#000; padding:3px 8px; border-radius:5px; margin-left:8px;">
        Mañana
    </span>
    <span style="background:#e6e6e7; color:#000; padding:3px 8px; border-radius:5px; margin-left:8px;">
        Sin fecha
    </span>
    <span style="background:#ffffff; color:#000; padding:3px 8px; border-radius:5px; margin-left:8px; border:1px solid #ddd;">
        Otros días
    </span>
</div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll("table tbody tr").forEach(tr => {
        ...
        // Sin fecha
        if (!texto || texto === '-' || texto.toLowerCase() === 'sin fecha') {
            td.style.background = colores.sinFecha.bg;
            td.style.color = colores.sinFecha.text;
            td.innerText = "Sin fecha";
            return;
        }
        ...
        if (fecha.getTime() === hoy.getTime()) {
            td.style.background = colores.hoy.bg;
            td.style.color = colores.hoy.text;
            return;
        }

        // Mañana
        if (fecha.getTime() === manana.getTime()) {
            td.style.background = colores.manana.bg;
            td.style.color = colores.manana.text;
            return;
        }
    });
});
